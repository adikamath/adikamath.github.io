...
During this past year-end holiday season, I finally got my hands on my first Raspberry Pi. The lingering thought of scrathing that itch of doing some DIY electronics work and a "coincidental" video recommendation that I saw on YouTube finally led me to do some quick research and make the move. What is a Raspberry Pi you ask? It is one of the most popularly known mini-computers which is fully self-contained on one small board. You can hook it up to a monitor and use it with a keyboard and mouse as a full computer. 

Ofcourse the magic of the Raspberry Pi is that it can be customized with a wide array of electronic components and you can write and run code to create really cool DIY projects. In thi post, I wanted to write about you can do a basic set up of a Raspberry Pi. 
...
3. HDMI Cable
4. Micro SD Card 
5. Raspberry Pi Active Cooler 
6. Case (optional)

### Step 1: Load the Raspberry Pi OS

### Step 2: Install the cooler 

### Step 3: Power-up the Raspberry Pi

### Step 5: Explore your new Raspberry Pi

### Step 6: Change the screen resolution --> Menu --> Preferences --> Screen Resolution

### Step 6: Install latest updates 

### Step 7: Install VSCode

### Step 8: Set up SSH 

### Step 9: Reserve the IP Address for your Pi in your router
